...
//Bu Botun Yapımcısı Discord: pman#7730
//Bu Botun Düzenleyicisi & Geliştiricisi Discord: pman#7730

//Bu Botun Yapımcısı Discord: pman#7730
//Bu Botun Düzenleyicisi & Geliştiricisi Discord: pman#7730

//Bu Botun Yapımcısı Discord: pman#7730
//Bu Botun Düzenleyicisi & Geliştiricisi pman#7730
client.on("ready", () => {
	console.log(" ")
	console.log("-------------------------------------------------------------------------------")
	console.log("Bu Botun Yapımcısı Discord: pman#7730");
	console.log("Bu Botun Geliştiricisi Discord: pman#7730");
	console.log("-------------------------------------------------------------------------------")
	console.log(" ")
	...
	if (db.get("owosystemstatus") == "1") {
		if (db.get("systems.wcf") == "1") {
		  ...
		  if(db.get("wprefix") == "1" ) {
			...
			let para = ['5000','5500','6000','6500','7000'];
			...
			db.add("cf", 1);
			client.channels.get(db.get("channelid")).send("owo cf 7000");
			console.log("OwO Coinflip komutu kullanıldı.")
...
setInterval(function(){
	if (db.get("owosystemstatus") == "1") {
		if (db.get("systems.wslot") == "1") {
			...
			db.add("slot", 1);
			client.channels.get(db.get("channelid")).send(owoslot + " " + para + "");
			console.log("OwO Slot komutu kullanıldı.")
		} else {
			
			db.add("slot", 1);
			client.channels.get(db.get("channelid")).send("owo slot 7000");
			console.log("OwO Slot komutu kullanıldı.")
		}
		}
	}
